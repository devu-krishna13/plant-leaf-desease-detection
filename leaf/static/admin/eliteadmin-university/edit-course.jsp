                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form class="form-material form-horizontal" action="http://localhost:8080/EYE_C_TEST/EditCourse" method="post">
                                    <div class="form-group">
                                        <label class="col-md-12" for="example-text">Course Name</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="example-text" name="t1" class="form-control" placeholder="enter course name" value="<%=f1%>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="sdate" name="t2" class="form-control mydatepicker" placeholder="enter date here" value="<%=f2%>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="duration" name="t3" class="form-control" placeholder="time span of the course" value="<%=f3%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="price">Course Fee </label>
                                        <div class="col-md-12">
                                            <input type="text" id="price" name="t4" class="form-control" placeholder="course fees" value="<%=f4%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="professor">Course Professor</label>
                                        <div class="col-md-12">
                                            <input type="text" id="professor" name="t5" class="form-control" placeholder="professor name" value="<%=f5%>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="year" name="t8" class="form-control" placeholder="e.g. First Year" value="<%=f8%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Description</label>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="3" name="t9"><%=f9%></textarea>
                                        </div>
                                    </div>
