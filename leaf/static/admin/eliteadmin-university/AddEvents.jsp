...
<body>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-chart p-r-10"></i> <span class="hide-menu">Events <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="AddEvents.jsp"> add Events</a></li>
                            <li> <a href="AddEvents.jsp?pg=v">view Events</a></li>
                        </ul>
                    </li>
    ...
    c.search("select * from addevent where college='"+session.getAttribute("uname")+"'");
    while(c.rs.next())
    {
    %>
    <tr>
         ...
         <td><%=c.rs.getString(2)%></td>
          <td><%=c.rs.getString(3)%></td>
           <td><%=c.rs.getString(4)%></td>
                  ...
                  <td><a href="Delete?eid=<%=c.rs.getString(1)%>">Delete</a></td>
     ...
     %>
                                    ...
                                    <h3 class="box-title">Compose New Event</h3>
                                    ...
                                    <div class="form-group">
                                        <textarea class="textarea_editor form-control" rows="15" placeholder="Enter Event  Content..." name="content"></textarea>
                                    </div>                  
                                    <hr>
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Send to public</button>
