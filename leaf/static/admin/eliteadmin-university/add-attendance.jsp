            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Attendance</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                                 <form class="form-material form-horizontal" method="post" action="../../AddAttendance">                    
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Add Attendance Details</h3>
                            <hr>
                ...
                c.search("select * from add_stud_main");          
                    while(c.rs.next())
                  {                  
                 %>
                                   
                                        <tr>
                                            <td><input type="hidden" value="<%=c.rs.getString(7)%>" name="t1"> <%=c.rs.getString(7)%></td>
                                            <td><input type="hidden" value="<%=c.rs.getString(1)%>" name="t2"><%=c.rs.getString(1)%></td>
                                            <td><input type="hidden" value="<%=c.rs.getString(8)%>" name="tu"><%=c.rs.getString(8)%></td>                                          
                                            <td><input type="hidden" value="<%=c.rs.getString(12)%>" name="t3"><%=c.rs.getString(12)%></td>
                                            <td><input type="hidden" value="<%=c.rs.getString(5)%>" name="t4"> <%=c.rs.getString(5)%></td>
                                            <td><input type="hidden" value="<%=c.rs.getString(6)%>" name="t5"><%=c.rs.getString(6)%></td>
                                            <td><input type="text" value="<%=c.rs.getString(1)%> with Register Number <%=c.rs.getString(7)%> is absent today"  name="t6"></td>
                                            <td><input type="checkbox" class="js-switch" data-color="#f96262" data-secondary-color="#99d683" value="<%=c.rs.getString(1)%>"  name="t7"></td>
                                        </tr>
                            <%
                       }
                       %>       
                       ...
                       <center><button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Submit</button>
