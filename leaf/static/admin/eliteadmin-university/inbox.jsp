            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Contact Us Messages</h4> </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                                     <div> <h3 class="panel-title m-t-40 m-b-0">Labels</h3>
                                        <hr class="m-t-5">
                                        <div class="list-group b-0 mail-list"> <a href="#" class="list-group-item"><span class="fa fa-circle text-info m-r-10"></span>FEEDBACKS</a> <a href="#" class="list-group-item"><span class="fa fa-circle text-warning m-r-10"></span>COMMENTS</a> <a href="#" class="list-group-item"><span class="fa fa-circle text-purple m-r-10"></span>ENQUIRY</a> <a href="#" class="list-group-item"><span class="fa fa-circle text-danger m-r-10"></span>ADMISSIONS</a> <a href="#" class="list-group-item"><span class="fa fa-circle text-success m-r-10"></span>SEM FEES</a> </div>
                                    </div>
                                </div>
                ...
                c.search("select * from contact_us");          
                    while(c.rs.next())
                  {                  
                 %>
                                                <tr class="unread">
                                                    ...
                                                    <td class="hidden-xs"><%=c.rs.getString(2)%></td>
                                                    <td class="max-texts"> <a href="inbox-detail.jsp" /><span class="label label-info m-r-10">Feedbacks</span><%=c.rs.getString(3)%></td>
                                                   
                                                    <td class="hidden-xs"><i class="fa fa-paperclip"></i></td>
                                                    <td class="text-right"><%=c.rs.getString(1)%></td>
                                                </tr>
                                     <%
                       }
                %>    
