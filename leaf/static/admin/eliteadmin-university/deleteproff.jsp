            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Professor Profile</h4> </div>
                            ...
                            <div class="user-btm-box">
                                ...
                                <div class="row text-center m-t-10">
                                    <strong>Name</strong>
                                      ...
                                      <hr>
                                    <div class="row text-center m-t-10"><strong>Designation&Department</strong>
                                        <p><%=f6%>,<%=f5%></p>
                                    </div>
                                ...
                                <div class="row text-center m-t-10">
                                    ...
                                    <h4><a href="https://<%=f8%>"><%=f8%></a></h4>                                    
                                </div>
                                <hr>
                                <div class="row text-center m-t-10">
                                    <form action="../../DelProffMain" method="post"> 
                                        <input type="hidden" name="tx" value="<%=f9%>">
                                        <button type="submit" class="btn btn-inverse waves-effect waves-light">Drop Professor</button>
                                    </form>                                   
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="../plugins/images/users/hritik.jpg" alt="user-img" class="img-circle"> <span>Jane Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="../plugins/images/users/Jane.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
