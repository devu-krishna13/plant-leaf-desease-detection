            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Scores</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Score Details</h3>
                            <hr>
                ...
                c.search("select * from add_score_main");          
                    while(c.rs.next())
                  {                  
                 %>
                                        ...
                                        <tr>
                                            <th><%=c.rs.getString(1)%></th>
                                            <th><%=c.rs.getString(2)%></th>
                                            <th><%=c.rs.getString(3)%>,<%=c.rs.getString(4)%></th>
                                            <th><%=c.rs.getString(5)%></th>
                                            <th><%=c.rs.getString(6)%></th>
                                            <th><%=c.rs.getString(7)%></th>
                                            <th><%=c.rs.getString(8)%></th>
                                            <th><%=c.rs.getString(9)%></th>
                                            <th><%=c.rs.getString(10)%></th>  
                                            <th>
                                                  <a href="edit-score.jsp?stid=<%=c.rs.getString(1)%>"> <button type="button" class="btn btn-success btn-circle"><i class="fa fa-link"></i> </button></a>
                          <a href="deletescore.jsp?stid=<%=c.rs.getString(1)%>">  <button type="button" class="btn btn-warning btn-circle"><i class="fa fa-times"></i> </button></a>
