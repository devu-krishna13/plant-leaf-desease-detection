<%-- 
    Document   : AddCampusStaff
    Created on : 15 Mar, 2019, 2:03:29 PM
    Author     : HP
--%>
      ...
      <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <!-- /.col-lg-12 -->
                               ...
                               <form class="form-material form-horizontal" method="post" action="../../AddproffMain">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <div class="form-material form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="date" id="bdate" name="t2" max="2000-01-01" class="form-control mydatepicker" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="position" name="t6" class="form-control" placeholder="e.g. Asst. Professor">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Description</label>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="3" name="t7"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="url">Website URL</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="url" name="t8" class="form-control" placeholder="your website">
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-material form-horizontal"> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" id="example-email" name="t9" class="form-control" placeholder="enter your email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="example-phone">Phone</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="example-phone" name="t10" class="form-control" placeholder="enter your phone" data-mask="(999) 999-9999">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="pwd">Password</span></label>
                                        <div class="col-md-12">
                                            <input type="password" id="pwd" name="t11" class="form-control" placeholder="enter your password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="cpwd">Confirm Password</span></label>
                                        <div class="col-md-12">
                                            <input type="password" id="cpwd" name="t12" class="form-control" placeholder="confirm your password">
                                        </div>
                                    </div>
                                <!--    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Submit</button>
                                    <button type="reset" class="btn btn-inverse waves-effect waves-light">Cancel</button>    
                            ...
                            <div class="white-box">
                                ...
                                <div class="form-material form-horizontal" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="furl" name="t13" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="turl">Twitter URL</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="turl" name="t14" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="gurl">Google Plus URL</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="gurl" name="t15" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="inurl">LinkedIN URL</span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="inurl" name="t16" class="form-control">
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Submit</button>
                                    <button type="reset" class="btn btn-inverse waves-effect waves-light">Cancel</button>    
