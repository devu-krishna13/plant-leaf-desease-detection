<%-- 
    Document   : Minig
    Created on : 21 Mar, 2019, 10:18:24 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        $("#bt").click(function(){
            //alert("Sdsd");
  $("#vv").load("Files.jsp?dt="+$("#dt").val()+"&d1="+$("#d1").val()+"&did="+$("#di").val(), function(responseTxt, statusTxt, xhr){
...
function pre(id,v,p) {
 location.href="behaviorprediction.jsp?dt="+v+"&d1="+id+"&did="+p;
                        ...
                        <div class="col-sm-6">
                         ...
                         <div class="col-sm-6">
                            <div class="white-box">
                                ...
                                <div class="form-material form-horizontal" id="vv1" >
